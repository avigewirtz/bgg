...
//     useEffect(() => {
//         if (pressReleaseData) {
//             // Update state for each form field with the data from pressReleaseData
...
//             setLeadPlaintiffDeadline(pressReleaseData.leadPlaintiffDeadline ? new Date(pressReleaseData.leadPlaintiffDeadline) : null);
//             setClassPeriodStartDate(pressReleaseData.classPeriodStartDate ? new Date(pressReleaseData.classPeriodStartDate) : null);
//             setClassPeriodEndDate(pressReleaseData.classPeriodEndDate ? new Date(pressReleaseData.classPeriodEndDate) : null);
//             setCaseDetails(pressReleaseData.caseDetails);
//             setIpoDate(pressReleaseData.ipoDate ? new Date(pressReleaseData.ipoDate) : null);
//             setInvestigationParagraph(pressReleaseData.investigationParagraph);
//             setPurchaseDate(pressReleaseData.purchaseDate ? new Date(pressReleaseData.purchaseDate) : null);
//             setSpacFullName(pressReleaseData.spacFullName);
//             setSpacShortName(pressReleaseData.spacShortName);
//             setMergerDate(pressReleaseData.mergerDate ? new Date(pressReleaseData.mergerDate) : null);
...
//     const wordpressPageId = response.data.id;
